...
function goModify(){
	form = document.searchForm;
	form.action = "<c:url value='/kdn/admin/codeWrite.do'/>";
	form.submit();
}
...
function goDelete(){
	...
	if (confirm('정말로 삭제 하시겠습니까?')) {
		form.action = "<c:url value='/kdn/admin/codeDelete.do'/>";
		form.submit();	
	}
}
</script>
	...
	<div id="wrap"> 
		...
		<div id="contents">
			<form name="searchForm" id="searchForm" method="post" >
				...
				<input id="chk" name="chk" type="hidden" value="<c:out value='${viewBox.group_code_id}/${viewBox.code_id}'/>" /><!-- 삭제 처리 하기 위해 키값 셋팅 파라메터  -->
				<!-- 검색 파라메터  -->
			...
			<!-- top -->
				<div class="top">
					<h3>공통코드 상세</h3>
					<p class="navi">
						<strong>Home</strong> &gt; 공통코드 관리 &gt; <strong class="location">공통코드 상세</strong>
					</p>
				</div>
				<!-- // top -->
			<table width="700" border="0" cellpadding="0" cellspacing="0"	>
				<tr>
					<th class="th_top">공통코드ID&nbsp;&nbsp;</th>
					<td class="td_top" style="padding-left:10px">${viewBox.code_id}</td>
				</tr>
				<tr>
					<th>공통코드ID명&nbsp;&nbsp;</th>
					<td style="padding-left:10px">${viewBox.code_name}</td>
				</tr>
				<tr>
					<th>공통코드 설명&nbsp;&nbsp;</th>
					<td style="padding-left:10px">${viewBox.code_account}</td>
				</tr>
				<tr>
					<th>정렬순서&nbsp;&nbsp;</th>
