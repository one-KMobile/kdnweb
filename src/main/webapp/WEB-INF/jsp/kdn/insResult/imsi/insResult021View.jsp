	...
	<div id="wrap">
		...
		<header>  
            ...
            <ul>      
                ...
                <li id="top_107000" class="current"><a href="<c:url value='/kdn/admin/insResultImsiView.do'/>?ins_ty_cd=021" >기별점검</a></li>
								...
								<c:forEach var="result" items="${subList}" varStatus="status">
									<tr>
										...
										<td id = "eqp_${result.eqp_no}"> 
											<span style="float:left;"><c:out value="${result.eqp_nm}" /></span>
										</td>
										<td>
