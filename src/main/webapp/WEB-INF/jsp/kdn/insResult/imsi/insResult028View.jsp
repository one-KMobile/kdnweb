	...
	<div id="wrap">
		...
		<header>  
            ...
            <ul>      
                ...
                <li id="top_103000" class="current"><a href="<c:url value='/kdn/admin/insResultImsiView.do'/>?ins_ty_cd=028" >접지저항</a></li>
		...
		<form id="frm" name="frm" method="post" action="<c:url value='/kdn/admin/insResultList.do'/>">
			...
			<div class="container">
				...
				<div style="float: left;width: 1033px;margin-bottom: 10px">
					<div style="margin-top: 10px;padding-left: 18px;font-weight: bold;margin-bottom: 12px;float: left;">○ 접지저항측정 점검</div>
							...
							<tbody>   
								<c:forEach var="result" items="${subList}" varStatus="status">
									<tr>
										...
										<td> 
											<c:out value="${result.msr_co}" />
										</td>
										<td>
											<c:out value="${result.value_1}" />
										</td>
										<td>
											<c:out value="${result.value_2}" />
										</td>
										<td>
											<c:out value="${result.value_3}" />
										</td>
										<td>
											<c:out value="${result.value_5}" />
										</td>
										<td>
											<c:out value="${result.value_10}" />
										</td>
										<td>
											<c:choose>   
										...
										<td>
											<span style="float:left;padding-left:10px;"><c:out value="${result.pmttr}" /></span>  
										</td>
									</tr>
								</c:forEach> 
