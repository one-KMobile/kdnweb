...
<script type="text/javascript">
	$(document).ready(function(){		
		//$('#topmenu').topmenu({ d1: 7, d2: 2 });  
		$('#topmenu').topmenu({ d1: "107000", d2: "107002" });  
	});
	...
	$(document).ready(function () {
		...
		* 달력 자바스크립트 세팅
		━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
		$(function () {
			var dates = $("#traking_date").datepicker({
				defaultDate: "+1w",
				changeMonth: true,
				onSelect: function (selectedDate) {
					var option = this.traking_date == "traking_date" ? "minDate" : "maxDate", 
	...
	* 검색
	...
	function goSearch(){
		...
		document.frm.action = "<c:url value='/kdn/traking/user/Patrolman.do'/>";
		document.frm.submit();
...
/* 	 	var latitude = ${viewBox.latitude};
	...
	* 트래킹 목록 셋팅
	━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
 	...
 	function setTrakingUserList(traking_date){
		var data = getTrakingByUserList($("#user_id").val(), $("#fst_bizplc_cd").val(), $("#scd_bizplc_cd").val(), traking_date);
		if(data.trakingUserList.length == 0) {
			alert("해당날짜의 순시트래킹 이력이 없습니다. 날짜를 다시 선택해주세요"); 
			var mapStr =""; 
			mapStr += "<tr>";
			mapStr += "<td>목록 검색을 다시 선택해주세요</td>";
			mapStr += "</tr>";
		...
		//mapStr += "<a href='javascript:goMapList(\""+arrayLatitude+"\",\""+arrayLongitude+"\",\""+arrayUsername+"\",\""+arrayRegdate+"\");' target='_self'><img src='<c:url value='/images/kdn/common/btn_search.gif' />' id='img1' onClick='setTrakingUserList(\"" +traking_date+"\");' alt='검색' style='padding-left: 10PX;'/></a>";
		/*$("#mapDiv").*/
		//mapStr += goMapList(arrayLatitude, arrayLongitude, arrayUsername, arrayRegdate);
		location.href(goMapList(arrayLatitude.toString(), arrayLongitude.toString(), arrayUsername.toString(), arrayRegdate.toString()));
		...
		oMap.attach('click', function(oCustomEvent) {
            ...
            if (oTarget instanceof nhn.api.map.Marker) {
                    ...
                    oInfoWnd.setContent('<DIV style="border-top:1px solid; border-bottom:2px groove black; border-left:1px solid; border-right:2px groove black;margin-bottom:1px;color:black;background-color:white; width:auto; height:auto;">'+
                            ...
                            oTarget.getTitle().substring(0, oTarget.getTitle().indexOf(":")) + '<br /> ' + oTarget.getPoint()
                            +'<span></div>');
	...
	* 달력 이미지 클릭시 달력 표시
	━━━━━━━━━━━━━━━━━━━━━━━━━━━━━*/
	function calljscal(traking_date) {
		$('#' + traking_date).datepicker("show");
	}
...
<body>
	...
	<!-- // Top Area -->
		...
		<form id="frm" name="frm" method="post" action="<c:url value='/kdn/traking/user/Patrolman.do'/>"> <!-- target="_hidden" -->
					...
					<ul>
						...
						<li>
							<div id="dateDiv">
								...
								<img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지" onClick="calljscal('traking_date')" >
								
								<a href="javascript:goSearch();" target="_self"><img src='<c:url value="/images/kdn/common/btn_search.gif" />' id="search" name="search" alt="검색" style="padding-left: 10PX;"/></a>
 								<div id="mapDiv" style="float: right; padding-right: 600px;"></div>
