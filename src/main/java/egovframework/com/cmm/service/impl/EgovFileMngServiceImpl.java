...
public class EgovFileMngServiceImpl extends AbstractServiceImpl implements EgovFileMngService {
     ...
     * 파일 갯수를 조회한다.
     * 
     * @see egovframework.com.cmm.service.EgovFileMngService#getFileCount(egovframework.com.cmm.service.FileVO)
     */
     ...
     * 전체 파일을 삭제한다.
     */
    public void delAllFileInfBox(Box box) throws Exception {
    	fileMngDAO.delAllFileInfBox(box);
    }
}
