...
@Repository("kdnAdminDAO")
public class KdnAdminDAO extends KdnSqlMapClient{
	...
	public List<Box> getAdminList(Box box) throws Exception {
		return list("adminDAO.getAdminList", box);
	}
	...
	public Box getAdminInfo(Box box) throws Exception {
		return (Box)selectByPk("adminDAO.getAdminInfo", box);
	}
	...
	public int setAdminUpdate(Box box) throws Exception {
		return update("adminDAO.setAdminUpdate", box);
	}
	...
	public int getAdminTotalCount(Box box) throws Exception {
		return (Integer) selectByPk("adminDAO.getAdminTotalCount", box);
	}
	...
	public Object setAdminInsert(Box box) throws Exception {
		return insert("adminDAO.setAdminInsert", box);
	}
	...
	public int setAdminDelete(Box box) throws Exception {
		return delete("adminDAO.setAdminDelete", box); 
	}
	...
	public Box getBizplcNameInfo(Box box) throws Exception {
		return (Box)selectByPk("adminDAO.getBizplcNameInfo", box);
	}
	...
	public List<Box> getAdminIsNotTokenList(Box box) {
		return list("adminDAO.getAdminIsNotTokenList", box);
	...
	public int setDeviceDel(Box box) {
		return update("adminDAO.setDeviceDel", box);
	}
	...
	public Box getUserToken(Box box) {
		return (Box)selectByPk("adminDAO.getUserToken", box);
	}
	...
	public List<Box> getUserTokenList(Box box) {
		return list("adminDAO.getUserTokenList", box);
	}
	...
	public Box isExistToUserid(Box box) throws Exception{
		return (Box)selectByPk("adminDAO.isExistToUserid", box);
	}
}
