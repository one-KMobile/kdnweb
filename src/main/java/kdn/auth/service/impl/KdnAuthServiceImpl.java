...
@Service("kdnAuthService") 
public class KdnAuthServiceImpl extends AbstractServiceImpl implements   
        KdnAuthService { 
	
	/** SampleDAO */
    @Resource(name="kdnAuthDAO")
    private KdnAuthDAO kdnAuthDAO;
	...
	public List<Box> getAuthList(Box box) throws Exception {
		return kdnAuthDAO.getAuthList(box);
	}
	...
	public int getAuthListTotCnt(Box box) {
		return kdnAuthDAO.getAuthListTotCnt(box);
	}
	...
	public Box getAuthView(Box box) throws Exception {
		Box viewBox = kdnAuthDAO.getAuthView(box);
		return viewBox;
	}
	...
	public int getAuthIdOverlapCount(Box box) {
		return kdnAuthDAO.getAuthIdOverlapCount(box);
	}
	...
	public List<Box> getMenuGrantAuthList(Box box) throws Exception {
		return kdnAuthDAO.getMenuGrantAuthList(box);
	}
	...
	public void menuGrantAuthSave(Box box) throws Exception {
		kdnAuthDAO.menuGrantAuthSave(box);
	}
	...
	public void menuGrantAuthUpdate(Box box) throws Exception {
		kdnAuthDAO.menuGrantAuthUpdate(box);
	}
	...
	public int getMenuGrantAuthCnt(Box box) {
		return kdnAuthDAO.getMenuGrantAuthCnt(box);
	}
	...
	public List<Box> getLeftMenuList(Box box) throws Exception {
		return kdnAuthDAO.getLeftMenuList(box);
	}
	...
	public int authUserInfoCnt(Box box) {
		return kdnAuthDAO.authUserInfoCnt(box);
	}
	...
	public List<Box> getAuthCodeValue(Box box) throws Exception{
		return kdnAuthDAO.getAuthCodeValue(box);
	}
}
